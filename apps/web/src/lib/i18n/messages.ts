...
export const messages = {
  ...
  'inbox.dup.found': { zh: '第 {i}/{n} 组重复({dim}),已预选,用底部栏处理。', en: 'Group {i}/{n} ({dim}) selected — use the bottom bar to act.' },
  'inbox.dup.dim.url': { zh: '同链接', en: 'same URL' },
  'inbox.dup.dim.code': { zh: '同代码', en: 'same code' },
  'inbox.dup.dim.title': { zh: '同标题', en: 'same title' },
