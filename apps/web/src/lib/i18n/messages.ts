...
export const messages = {
  ...
  'nav.ask': { zh: 'AI 对话', en: 'Ask AI' },  'nav.graph': { zh: '图谱', en: 'Graph' },
  ...
  'settings.labs.lede': { zh: '附加能力,默认关闭。开启即表示你接受额外风险。', en: 'Optional capabilities, off by default. Enabling means you accept added risk.' },
  'settings.labs.none': { zh: '当前没有已实现且需要实验开关的功能。', en: 'No implemented features currently require an experimental toggle.' },
