...
.sf__tag { transition: transform var(--duration-press) var(--ease-standard); }
.sf__tag:active { transform: scale(0.98); animation: tactile-flash var(--duration-flash) ease-out; }
