...
export type CanvasIconName =
  ...
  | 'dsl' | 'export' | 'diff' | 'shortcuts' | 'search' | 'inbox'
  | 'more'
...
const MAP: Record<CanvasIconName, LucideIcon> = {
  ...
  dsl: Braces, export: Upload, diff: GitCompare, shortcuts: Keyboard, more: MoreHorizontal, search: Search, inbox: Inbox,
}
