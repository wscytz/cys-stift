...
> 基础骨架(SelfBuiltAdapter + 渲染 + 拖拽 + pan/zoom + `/dev/canvas-self`)的逐步 TDD 计划见 `docs/plans/2026-06-22-canvas-self-build-phase1-foundation.md`。freedraw(手绘)计划见 `docs/plans/2026-06-22-canvas-self-build-phase1-freedraw.md`。arrow(关系箭头渲染)计划见 `docs/plans/2026-06-22-canvas-self-build-phase1-arrow.md`。text(文本编辑含 IME)计划见 `docs/plans/2026-06-22-canvas-self-build-phase1-text.md`。交互打磨(1)选择+高亮+Delete 计划见 `docs/plans/2026-06-22-canvas-self-build-phase1-selection.md`。打磨(2)resize handle 计划见 `docs/plans/2026-06-22-canvas-self-build-phase1-resize.md`。多选/arrow 交互创建/更多键盘/Phase 2 各自另开 plan。
