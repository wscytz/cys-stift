...
> 基础骨架(SelfBuiltAdapter + 渲染 + 拖拽 + pan/zoom + `/dev/canvas-self`)的逐步 TDD 计划见 `docs/plans/2026-06-22-canvas-self-build-phase1-foundation.md`。freedraw(手绘)计划见 `docs/plans/2026-06-22-canvas-self-build-phase1-freedraw.md`。arrow(关系箭头渲染)计划见 `docs/plans/2026-06-22-canvas-self-build-phase1-arrow.md`。text(文本编辑含 IME)计划见 `docs/plans/2026-06-22-canvas-self-build-phase1-text.md`。arrow 交互创建/打磨/Phase 2 各自另开 plan。
