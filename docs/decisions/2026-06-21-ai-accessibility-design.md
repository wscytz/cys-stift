...
完整对话上下文见 `docs/feedback/2026-06-21-ai-feedback.md`。摘要:
...
| `docs/decisions/2026-06-21-ai-accessibility-design.md` | 跨模型记忆 | ✅ v0.30.0(本文档) |
| `docs/feedback/2026-06-21-ai-feedback.md` | 用户原话归档 | ✅ v0.30.0 |
| `CLAUDE.md` | 主锚点 | ✅ 加 v0.30.0 记录 |
| `apps/web/CLAUDE.md` | web 锚点 | ✅ 加 AI 改动 check-list |
| `MEMORY.md` | 索引 | ✅ 加新条目 |
| `docs/changelog.md` | 历史 | ✅ v0.30.0 条目 |
