...
- **canvas**:自研 Canvas 2D 自由画布(矩形/椭圆/箭头/便签/文本/手绘)+ 多画布 CRUD + 视图持久化 + 关系箭头(弯曲/折线形态 + 手绘识别)+ AI 排版 + 导出 SVG/PNG
...
> **当前阶段:打磨期(2026-06-26 起)** — 主线 + P10 + UI/a11y/鲁棒三轮全完成。
