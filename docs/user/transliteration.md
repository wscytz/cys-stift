...
大多数画布工具的画布是**图形**——只有看得见、用鼠标改。我们的画布是**可被文字完全描述、且文字可改的图形**。
...
- 设计与定位、当前状态:见 [Release notes](https://github.com/wscytz/cys-stift/releases) 与 [changelog](../changelog.md);产品定位 / 状态板等过程文档在私有仓 `cys-stift-docs`
